...
let AuthenticationService = class AuthenticationService {
    ...
    login(username, password, company, developer) {
        ...
        return this.http.post("vnmarcus/md", parameterString, { headers })
...
let HomeComponent = class HomeComponent {
    constructor(changeDetectorRef, media, toast, authenticationService) {
        this.toast = toast;
...
let OrderlistComponent = class OrderlistComponent {
    ...
    ngOnInit() {
        this.orderService.getOrderList((res) => {
            this.orderList = res;
